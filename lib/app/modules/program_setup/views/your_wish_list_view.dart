...
class YourWishListView extends GetView<ProgramSetupController> {
  @override
  Widget build(BuildContext context) {
    return controller.obx((state) => Container(
          child: ListView.builder(
            itemCount: controller.yourWishList.length,
              ...
              return Container(
                ...
                child: Card(
                  ...
                  child: Theme(
                    ...
                    child: InkWell(
                      onTap: () {
                        controller.yourWishListPosition = index;
                        controller.update();
                      },
                      child: Container(
                        ...
                        decoration: controller.yourWishListPosition == index
                            ? BoxDecoration(
                                borderRadius:
